		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom FIORI app on KYMA",
									"targetURL": "#awskymafioriawskyma-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"awskymafioriawskyma-display": {
								"semanticObject": "awskymafioriawskyma",
								"action": "display",
								"description": "Custom FIORI app on KYMA",
								"title": "Custom FIORI app on KYMA",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aws.kyma.fioriawskyma",
									"url": sap.ui.require.toUrl("aws/kyma/fioriawskyma")
								}
							}
						}
					}
